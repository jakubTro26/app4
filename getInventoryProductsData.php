                 ...
                 // var_dump(get_object_vars($PHPcontent->products->$property->variants));
                       ...
                       for($k=0;$k<count(get_object_vars($PHPcontent->products->$property->variants));$k++){
                        ...
                        if(strlen($PHPcontent->products->$property->text_fields->{'name|en'})>0){
                          ...
                          $product->appendChild( $dom->createElement('description_extra1|it',$PHPcontent->products->$property->text_fields->{'description_extra1|it'} ) );
                          $product->appendChild( $dom->createElement('description_extra1|nl',$PHPcontent->products->$property->text_fields->{'description_extra1|nl'} ) );
                          $product->appendChild( $dom->createElement('description_extra2',$PHPcontent->products->$property->text_fields->description_extra2 ) );
                          $product->appendChild( $dom->createElement('description_extra2|en',$PHPcontent->products->$property->text_fields->{'description_extra2|en'} ) );
                          $product->appendChild( $dom->createElement('description_extra2|de',$PHPcontent->products->$property->text_fields->{'description_extra2|de'} ) );
                          $product->appendChild( $dom->createElement('description_extra2|fr',$PHPcontent->products->$property->text_fields->{'description_extra2|fr'} ) );
                          $product->appendChild( $dom->createElement('description_extra2|es',$PHPcontent->products->$property->text_fields->{'description_extra2|es'} ) );
                          $product->appendChild( $dom->createElement('description_extra2|it',$PHPcontent->products->$property->text_fields->{'description_extra2|it'} ) );
                          $product->appendChild( $dom->createElement('description_extra2|nl',$PHPcontent->products->$property->text_fields->{'description_extra2|nl'} ) );
                          $product->appendChild( $dom->createElement('description_extra3',$PHPcontent->products->$property->text_fields->description_extra3 ) );
                          $product->appendChild( $dom->createElement('description_extra3|en',$PHPcontent->products->$property->text_fields->{'description_extra3|en'} ) );
                          $product->appendChild( $dom->createElement('description_extra3|de',$PHPcontent->products->$property->text_fields->{'description_extra3|de'} ) );
                          $product->appendChild( $dom->createElement('description_extra3|fr',$PHPcontent->products->$property->text_fields->{'description_extra3|fr'} ) );
                          $product->appendChild( $dom->createElement('description_extra3|es',$PHPcontent->products->$property->text_fields->{'description_extra3|es'} ) );
                          $product->appendChild( $dom->createElement('description_extra3|it',$PHPcontent->products->$property->text_fields->{'description_extra3|it'} ) );
                          $product->appendChild( $dom->createElement('description_extra3|nl',$PHPcontent->products->$property->text_fields->{'description_extra3|nl'} ) );
                          $product->appendChild( $dom->createElement('description_extra4',$PHPcontent->products->$property->text_fields->description_extra4 ) );
                          $product->appendChild( $dom->createElement('description_extra4|en',$PHPcontent->products->$property->text_fields->{'description_extra4|en'} ) );
                          $product->appendChild( $dom->createElement('description_extra4|de',$PHPcontent->products->$property->text_fields->{'description_extra4|de'} ) );
                          $product->appendChild( $dom->createElement('description_extra4|fr',$PHPcontent->products->$property->text_fields->{'description_extra4|fr'} ) );
                          $product->appendChild( $dom->createElement('description_extra4|es',$PHPcontent->products->$property->text_fields->{'description_extra4|es'} ) );
                          $product->appendChild( $dom->createElement('description_extra4|it',$PHPcontent->products->$property->text_fields->{'description_extra4|it'} ) );
                          $product->appendChild( $dom->createElement('description_extra4|nl',$PHPcontent->products->$property->text_fields->{'description_extra4|nl'} ) );
