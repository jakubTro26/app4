<?php
    ...
    $idArray=['801','712','716','741','715','886','714','813','880','713','867','742','796','868','72','1184'];
//kubssa
                 ...
                 // var_dump(get_object_vars($PHPcontent->products->$property->variants));
                       ...
                       for($k=0;$k<count(get_object_vars($PHPcontent->products->$property->variants));$k++){
                        ...
                        if(strlen($PHPcontent->products->$property->text_fields->{'name|en'})>0){
                          ...
                          $product->appendChild( $dom->createElement('description_extra1_en',$PHPcontent->products->$property->text_fields->{"description_extra1|en"} ) );
                          $product->appendChild( $dom->createElement('description_extra1_de',$PHPcontent->products->$property->text_fields->{'description_extra1|de'} ) );
                          $product->appendChild( $dom->createElement('description_extra1_fr',$PHPcontent->products->$property->text_fields->{'description_extra1|fr'} ) );
                          $product->appendChild( $dom->createElement('description_extra1_es',$PHPcontent->products->$property->text_fields->{'description_extra1|es'} ) );
                          $product->appendChild( $dom->createElement('description_extra1_it',$PHPcontent->products->$property->text_fields->{'description_extra1|it'} ) );
                          $product->appendChild( $dom->createElement('description_extra1_nl',$PHPcontent->products->$property->text_fields->{'description_extra1|nl'} ) );
                          $product->appendChild( $dom->createElement('description_extra2',$PHPcontent->products->$property->text_fields->description_extra2 ) );
                          $product->appendChild( $dom->createElement('description_extra2_en',$PHPcontent->products->$property->text_fields->{'description_extra2|en'} ) );
                          $product->appendChild( $dom->createElement('description_extra2_de',$PHPcontent->products->$property->text_fields->{'description_extra2|de'} ) );
                          $product->appendChild( $dom->createElement('description_extra2_fr',$PHPcontent->products->$property->text_fields->{'description_extra2|fr'} ) );
                          $product->appendChild( $dom->createElement('description_extra2_es',$PHPcontent->products->$property->text_fields->{'description_extra2|es'} ) );
                          $product->appendChild( $dom->createElement('description_extra2_it',$PHPcontent->products->$property->text_fields->{'description_extra2|it'} ) );
                          $product->appendChild( $dom->createElement('description_extra2_nl',$PHPcontent->products->$property->text_fields->{'description_extra2|nl'} ) );
                          $product->appendChild( $dom->createElement('description_extra3',$PHPcontent->products->$property->text_fields->description_extra3 ) );
                          $product->appendChild( $dom->createElement('description_extra3_en',$PHPcontent->products->$property->text_fields->{'description_extra3|en'} ) );
                          $product->appendChild( $dom->createElement('description_extra3_de',$PHPcontent->products->$property->text_fields->{'description_extra3|de'} ) );
                          $product->appendChild( $dom->createElement('description_extra3_fr',$PHPcontent->products->$property->text_fields->{'description_extra3|fr'} ) );
                          $product->appendChild( $dom->createElement('description_extra3_es',$PHPcontent->products->$property->text_fields->{'description_extra3|es'} ) );
                          $product->appendChild( $dom->createElement('description_extra3_it',$PHPcontent->products->$property->text_fields->{'description_extra3|it'} ) );
                          $product->appendChild( $dom->createElement('description_extra3_nl',$PHPcontent->products->$property->text_fields->{'description_extra3|nl'} ) );
                          $product->appendChild( $dom->createElement('description_extra4',$PHPcontent->products->$property->text_fields->description_extra4 ) );
                          $product->appendChild( $dom->createElement('description_extra4_en',$PHPcontent->products->$property->text_fields->{'description_extra4|en'} ) );
                          $product->appendChild( $dom->createElement('description_extra4_de',$PHPcontent->products->$property->text_fields->{'description_extra4|de'} ) );
                          $product->appendChild( $dom->createElement('description_extra4_fr',$PHPcontent->products->$property->text_fields->{'description_extra4|fr'} ) );
                          $product->appendChild( $dom->createElement('description_extra4_es',$PHPcontent->products->$property->text_fields->{'description_extra4|es'} ) );
                          $product->appendChild( $dom->createElement('description_extra4_it',$PHPcontent->products->$property->text_fields->{'description_extra4|it'} ) );
                          $product->appendChild( $dom->createElement('description_extra4_nl',$PHPcontent->products->$property->text_fields->{'description_extra4|nl'} ) );
                          $product->appendChild( $dom->createElement('bp5',$PHPcontent->products->$property->text_fields->extra_field_11 ) );
                          $product->appendChild( $dom->createElement('searchtermsPL',$PHPcontent->products->$property->text_fields->extra_field_278 ) );
                          $product->appendChild( $dom->createElement('searchtermsEN',$PHPcontent->products->$property->text_fields->{'extra_field_278|en'} ) );
                          $product->appendChild( $dom->createElement('searchtermsDE',$PHPcontent->products->$property->text_fields->{'extra_field_278|de'} ) );
                          $product->appendChild( $dom->createElement('searchtermsFR',$PHPcontent->products->$property->text_fields->{'extra_field_278|fr'} ) );
                          $product->appendChild( $dom->createElement('searchtermsES',$PHPcontent->products->$property->text_fields->{'extra_field_278|es'} ) );
                          $product->appendChild( $dom->createElement('searchtermsIT',$PHPcontent->products->$property->text_fields->{'extra_field_278|it'} ) );
                          ...
                          $product->appendChild( $dom->createElement('image4',$PHPcontent->products->$property->images->{'4'} ) );
                          $product->appendChild( $dom->createElement('image5',$PHPcontent->products->$property->images->{'5'} ) );
                          $product->appendChild( $dom->createElement('image6',$PHPcontent->products->$property->images->{'6'} ) );
                          $product->appendChild( $dom->createElement('image7',$PHPcontent->products->$property->images->{'7'} ) );
                          $product->appendChild( $dom->createElement('image8',$PHPcontent->products->$property->images->{'8'} ) );
                          $product->appendChild( $dom->createElement('image9',$PHPcontent->products->$property->images->{'9'} ) );
                          $product->appendChild( $dom->createElement('image10',$PHPcontent->products->$property->images->{'10'} ) );
                          $product->appendChild( $dom->createElement('image11',$PHPcontent->products->$property->images->{'11'} ) );
                          $product->appendChild( $dom->createElement('image12',$PHPcontent->products->$property->images->{'12'} ) );
                          $product->appendChild( $dom->createElement('image13',$PHPcontent->products->$property->images->{'13'} ) );
                          $product->appendChild( $dom->createElement('image14',$PHPcontent->products->$property->images->{'14'} ) );
                          $product->appendChild( $dom->createElement('image15',$PHPcontent->products->$property->images->{'15'} ) );
                          $product->appendChild( $dom->createElement('image16',$PHPcontent->products->$property->images->{'16'} ) );
